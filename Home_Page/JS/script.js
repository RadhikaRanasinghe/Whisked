const modalOpenBtn = document.getElementById('comment-buttonid');
const modalCloseBtn = document.getElementById('close-comment');
...
modalSubmitButton.addEventListener('click',form_validation);

const enteredEmail = document.getElementById('input-email');
const modalSubmit = document.querySelector('.submit-comment');
